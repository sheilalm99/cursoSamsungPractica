//verificamos si el navegador soporta Filereader y API File
...
if (window.File && window.FileReader && window.FileList && window.Blob) {
    function handleFileSelect(evt) {
        ...
        reader.onload = (function (theFile) {
            return function (s) {
                ...
                div.innerHTML = '<video controls id="video" class="w-100 mt-3 align-items-center" src="' + s.target.result + '" title="' + escape(theFile.name) + '"/>';
                ...
                loadingMessage.innerHTML = 'Cargando vídeo...';
    ...
    alert('Las File APIs no están soportadas por este navegador.')
}